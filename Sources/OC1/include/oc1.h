...
struct tree_node *build_tree(struct point ** points, int no_of_points, char *dt_file);
void setDatasetParams(int dimensions, int categories);
allocate_structures(int no_of_points);
